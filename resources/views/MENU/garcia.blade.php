...
@section('content')
      ...
      <div class="my-3 p-3 bg-white rounded box-shadow">
        <h6 class="border-bottom border-gray pb-2 mb-0">GARCÍA DE LA CADENA</h6>
      ...
      <div style="position:absolute;  top:250px; left:800px; visibility:visible z- index:1" >
        ...
        <img class="d-block bg-dark-center" src="Estilos/img/garcia.jpg"  width=500, height=300>
      </p>
